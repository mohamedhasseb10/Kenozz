...
class FavouriteViewModel: BaseViewModel {
    ...
    let isSuccess: PublishSubject<FavouriteModel> = PublishSubject()
    ...
    var message = ""
    // MARK: - init
    public init (_ repo: FavouriteRepository = FavouriteRepository()) {
        repository = repo
    ...
    func getFavouriteData() {
        ...
        repository.getFavouriteData { [weak self] (result) in
            ...
            case .success(let data):
                if let data = data as? FavouriteModel {
